...
export const ModalAddVisitor = () => {
  const changeParticipants = useCurrentVisitsStore(
    (state) => state.changeAttendeesList
  );
  const isShowModal = useAddVisitorStore((state) => state.isShow);
  const changeShowModal = useAddVisitorStore((state) => state.changeIsShow);
  const users = useAddVisitorStore((state) => state.users);
  const getUsers = useAddVisitorStore((state) => state.getUsers);
  const participants = useAddVisitorStore((state) => state.participants);
